...
## Getting started
1. Read the [code of conduct](https://github.com/znmeb/dfstools/blob/master/CONDUCT.md) and [contributor's guide](https://github.com/znmeb/dfstools/blob/master/CONTRIBUTING.md).
...
1. Install git, R and RStudio for your work environment. This is a developers' release; for the moment, you'll need to be familiar with git / GitHub, R and RStudio. 
    ...
    I test regularly on Windows and Arch Linux, but any environment that supports RStudio should work. If anything doesn't work or the documentation is unclear, please file an issue at <https://github.com/znmeb/dfstools/issues/new>

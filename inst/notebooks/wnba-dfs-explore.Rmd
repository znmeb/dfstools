...
this_week <- regular_season_schedule %>% 
  dplyr::filter(
    game_start_time > '2019-08-03',
    game_start_time < '2019-08-11'
  )
season_team_feed <- dfstools::bdb_wnba_team(
  "~/Dropbox/19-wnba-team/08-01-2019-wnba-season-team-feed.xlsx"
)
...
season_dfs_feed <- dfstools::bdb_wnba_dfs(
  "~/Dropbox/19-wnba-dfs/08-01-2019-wnba-season-dfs-feed.xlsx"
) %>% dplyr::filter(

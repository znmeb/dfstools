...
this_week <- regular_season_schedule %>% 
  dplyr::filter(
    game_start_time > '2019-07-14',
    game_start_time < '2019-07-21'
  )
season_team_feed <- dfstools::bdb_wnba_team(
  "~/Dropbox/19-wnba-team/07-12-2019-wnba-season-team-feed.xlsx"
)
...
season_dfs_feed <- dfstools::bdb_wnba_dfs(
  "~/Dropbox/19-wnba-dfs/07-12-2019-wnba-season-dfs-feed.xlsx"
) %>% dplyr::filter(

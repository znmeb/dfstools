...
minutes_cutoff <- quantile(
  fanduel_main_slate$projected_minutes, probs = 0.50, na.rm = TRUE
)
...
fanduel_single_slate <- fanduel_projections %>% 
  ...
  dplyr::select(-fanduel_position)
minutes_cutoff <- quantile(
  fanduel_single_slate$projected_minutes, probs = 0.50, na.rm = TRUE
)
...
minutes_cutoff <- quantile(
  draftkings_slate$projected_minutes, probs = 0.50, na.rm = TRUE
)
